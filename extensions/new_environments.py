...
class RLTaskEnv(habitat.RLEnv):
    def __init__(self, config: "DictConfig", dataset: Optional[Dataset] = None):
        ...
        self._reward_measuer_ratio = 0.2
    ...
    def reset(
        ...
        res = super().reset(*args, return_info=return_info, **kwargs)
...
@habitat.registry.register_env(name="MyGymHabitatEnv")
class MyGymHabitatEnv(gym.Wrapper):
    """
